...
function preload(){
  ...
  MaincarImg = loadImage("car1-1.png");
  oppcar1Img = loadImage("car2-1.png");
  oppcar2Img = loadImage("car3-1.png");
  oppcar3Img = loadImage("car4-1.png");
